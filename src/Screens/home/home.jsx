...
const Home = () => {
  return (
    ...
    <div className="md:px-20 md:py-10 py-4 sm:px-2 sm:py-4 border-2 rounded-md shadow-xl">
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex-1 flex justify-around">
                      <div className="flex-1 flex gap-3">
                        <input
                          ...
                          onChange={() =>
                            setFieldValue("ExperienceLevel", "Fresher")
                          }
                        />
                      ...
                      <div className="flex-1 flex gap-3">
                        <input
                          ...
                          onChange={() =>
                            setFieldValue("ExperienceLevel", "Experienced")
                          }
                        />
            ...
            <div className="flex justify-center items-center">
              <button
                className="w-28 md:mb-0 h-10 bg-blue-500 text-white rounded-md hover:bg-blue-700"
                type="submit"
              >
                Submit
              </button>
